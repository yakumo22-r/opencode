...
export const dict = {
  ...
  "workflow.run.unavailable": "This workflow run is unavailable.",
  "workflow.run.nodes": "Nodes",
  "workflow.run.active": "Active",
  "workflow.run.cost": "Estimated cost",
  "workflow.run.graph": "Workflow graph",
  "workflow.run.connections": "connections",
  "workflow.run.noDirectory": "No workspace directory",
  "workflow.run.defaultModel": "Default model",
  "workflow.run.defaultModelNamed": "Default model ({{model}})",
  "workflow.run.activity": "Recent activity",
  "workflow.run.noActivity": "No workflow events yet",
  "workflow.run.costBreakdown": "Cost breakdown",
  "workflow.run.unpriced": "{{count}} unpriced attempts",
  "workflow.run.admit": "Admit ready",
  "workflow.run.admitting": "Admitting...",
  "workflow.run.execute": "Run admitted",
  "workflow.run.executing": "Running...",
  "workflow.run.advance": "Run until idle",
  "workflow.run.advancing": "Running until idle...",
  "workflow.run.openSession": "Open session",
  "workflow.run.noSession": "No session yet",
  "workflow.run.queue": "Pending handoffs",
  "workflow.run.noQueue": "No pending queue messages",
  "workflow.run.acknowledge": "Acknowledge",
  "workflow.run.acknowledging": "Acknowledging...",
  "workflow.run.connectionCount": "{{count}} connections",
  "workflow.run.event.status": "{{node}} is now {{status}}",
  "workflow.run.event.handoff": "{{source}} sent a handoff to {{target}}",
  "workflow.run.event.ack": "{{node}} acknowledged {{port}}",
  ...
  "workflow.home.eyebrow": "Workflows",
  "workflow.home.title": "Observe a workflow run",
  "workflow.home.description": "Open a durable workflow run to inspect node state, handoffs, and model cost.",
  "workflow.home.placeholder": "Workflow run ID",
  "workflow.home.open": "Open run",
  "workflow.home.projects": "Project",
  "workflow.home.noProject": "Open a project to list templates and runs.",
  "workflow.home.templates": "Templates",
  "workflow.home.noTemplates": "No workflow templates yet",
  "workflow.home.runs": "Recent runs",
  "workflow.home.noRuns": "No workflow runs yet",
  "workflow.home.create": "Create template",
  "workflow.home.creating": "Creating...",
  "workflow.home.titlePlaceholder": "Template title",
  "workflow.home.objectivePlaceholder": "What should the first node do?",
  "workflow.home.start": "Start run",
  "workflow.home.requirementPlaceholder": "What should this run do?",
  "workflow.home.starting": "Starting...",
  "workflow.home.nodeCount": "{{count}} nodes",
  "workflow.home.edit": "Edit",
  "workflow.home.examples": "Example templates",
  "workflow.home.examplesDescription": "Start with a ready-made workflow and customize it in the canvas.",
  "workflow.home.useExample": "Use example",
  "workflow.home.example.researchBuildTest.title": "Research, build and test",
  "workflow.home.example.researchBuildTest.description": "A sequential engineering workflow from investigation to implementation and verification.",
  "workflow.home.example.contentReview.title": "Content review",
  "workflow.home.example.contentReview.description": "Draft content, review it, then pause for human approval.",
  "workflow.home.example.parallelFeedback.title": "Parallel feedback",
  "workflow.home.example.parallelFeedback.description": "Send one task to two independent reviewers for parallel analysis.",
  "workflow.template.eyebrow": "Workflow template",
  "workflow.template.save": "Save",
  "workflow.template.saving": "Saving...",
  "workflow.template.addNode": "Add node",
  "workflow.template.addRoot": "Add root",
  "workflow.template.unavailable": "This workflow template is unavailable.",
  "workflow.template.invalid": "This graph could not be saved.",
  "workflow.template.nodeTitle": "Node title",
  "workflow.template.nodeObjective": "Node objective",
  "workflow.template.deleteNode": "Remove node",
  "workflow.template.deleteEdge": "Remove connection",
  "workflow.template.inputPort": "Input port",
  "workflow.template.outputPort": "Output port",
  "workflow.template.queuePort": "Queue input",
  "workflow.template.messagePort": "Message output",
  "workflow.template.basePrompt": "Project prompt file",
  "workflow.template.nodePrompt": "Node prompt file",
  "workflow.template.promptPlaceholder": ".opencode/workflow/prompt.md",
  "workflow.template.kind": "Kind",
  "workflow.template.agent": "Agent",
  "workflow.template.model": "Model",
  "workflow.template.modelPlaceholder": "provider/model",
  "workflow.template.directory": "Workspace directory",
  "workflow.template.directoryPlaceholder": "/path/to/project",
  "workflow.template.canvasHint": "Drag nodes to move. Ctrl-click to add to the selection. Drag empty canvas to box-select. Middle-drag to pan. Right-click for the menu.",
  "workflow.template.alias": "Alias",
  "workflow.template.notes": "Notes",
  "workflow.template.showInputs": "Show input ports",
  "workflow.template.hideInputs": "Hide input ports",
  "workflow.template.showOutputs": "Show output ports",
  "workflow.template.hideOutputs": "Hide output ports",
  "workflow.template.tools": "Allowed tools",
  "workflow.template.toolsAll": "All tools",
  "workflow.template.toolsSelected": "{count} selected",
  "workflow.template.inputs": "Inputs",
  "workflow.template.outputs": "Outputs",
  "workflow.template.showWorkspace": "Show workspace input",
  "workflow.template.hideWorkspace": "Hide workspace input",
  "workflow.template.showPrompt": "Show extra prompt input",
  "workflow.template.hidePrompt": "Hide extra prompt input",
  "workflow.template.extraPrompt": "Extra prompt text",
  "workflow.template.noDirectory": "No directory",
  "workflow.template.addPrompt": "Add prompt port",
  "workflow.template.addInput": "Add input port",
  "workflow.template.addOutput": "Add output port",
  "workflow.template.description.root": "Starts the workflow",
  "workflow.template.description.task": "General workflow task",
  "workflow.template.description.research": "Collects and analyzes information",
  "workflow.template.description.implement": "Changes files and builds the result",
  "workflow.template.description.review": "Checks quality and correctness",
  "workflow.template.description.test": "Runs tests and reports failures",
  "workflow.template.description.approval": "Waits for a human decision",
  "workflow.template.port.context": "Context",
  "workflow.template.port.inbox": "Inbox",
  "workflow.template.port.result": "Result",
  "workflow.template.port.message": "Message",
  "workflow.template.tooltip.input": "Input port",
  "workflow.template.tooltip.output": "Output port",
  "workflow.kind.root": "Root",
  "workflow.kind.task": "Task",
  "workflow.kind.research": "Research",
  "workflow.kind.implement": "Implement",
  "workflow.kind.review": "Review",
  "workflow.kind.test": "Test",
  "workflow.kind.approval": "Approval",
