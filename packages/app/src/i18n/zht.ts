...
export const dict = {
  ...
  "workflow.run.unavailable": "此工作流程執行無法使用。",
  "workflow.run.nodes": "節點",
  "workflow.run.active": "執行中",
  "workflow.run.cost": "預估成本",
  "workflow.run.graph": "工作流程圖",
  "workflow.run.connections": "條連線",
  "workflow.run.noDirectory": "沒有工作區目錄",
  "workflow.run.defaultModel": "預設模型",
  "workflow.run.defaultModelNamed": "預設模型（{{model}}）",
  "workflow.run.activity": "最近活動",
  "workflow.run.noActivity": "尚無工作流程事件",
  "workflow.run.costBreakdown": "成本明細",
  "workflow.run.unpriced": "{{count}} 次未定價嘗試",
  "workflow.run.admit": "接納就緒節點",
  "workflow.run.admitting": "正在接納...",
  "workflow.run.execute": "執行已接納節點",
  "workflow.run.executing": "正在執行...",
  "workflow.run.advance": "執行直到閒置",
  "workflow.run.advancing": "正在執行直到閒置...",
  "workflow.run.openSession": "開啟工作階段",
  "workflow.run.noSession": "尚無工作階段",
  "workflow.run.queue": "待處理交接",
  "workflow.run.noQueue": "沒有待處理的佇列訊息",
  "workflow.run.acknowledge": "確認",
  "workflow.run.acknowledging": "正在確認...",
  "workflow.run.connectionCount": "{{count}} 條連線",
  "workflow.run.event.status": "{{node}} 現在處於{{status}}",
  "workflow.run.event.handoff": "{{source}} 向 {{target}} 傳送了交接",
  "workflow.run.event.ack": "{{node}} 已確認 {{port}}",
  "workflow.status.pending": "待處理",
  "workflow.status.ready": "就緒",
  "workflow.status.running": "執行中",
  "workflow.status.waiting": "等待中",
  "workflow.status.blocked": "已封鎖",
  "workflow.status.completed": "已完成",
  "workflow.status.failed": "失敗",
  "workflow.status.cancelled": "已取消",
  "workflow.home.eyebrow": "工作流程",
  "workflow.home.title": "檢視工作流程執行",
  "workflow.home.description": "開啟一個持久化工作流程執行，檢視節點狀態、交接資訊與模型成本。",
  "workflow.home.placeholder": "工作流程執行 ID",
  "workflow.home.open": "開啟執行",
  "workflow.home.projects": "專案",
  "workflow.home.noProject": "開啟一個專案以列出範本與執行。",
  "workflow.home.templates": "範本",
  "workflow.home.noTemplates": "尚無工作流程範本",
  "workflow.home.runs": "最近執行",
  "workflow.home.noRuns": "尚無工作流程執行",
  "workflow.home.create": "建立範本",
  "workflow.home.creating": "正在建立...",
  "workflow.home.titlePlaceholder": "範本標題",
  "workflow.home.objectivePlaceholder": "第一個節點應該做什麼？",
  "workflow.home.start": "開始執行",
  "workflow.home.requirementPlaceholder": "這次執行要做什麼？",
  "workflow.home.starting": "正在開始...",
  "workflow.home.nodeCount": "{{count}} 個節點",
  "workflow.home.edit": "編輯",
  "workflow.home.examples": "案例範本",
  "workflow.home.examplesDescription": "從現成工作流程開始，再於畫布中繼續調整。",
  "workflow.home.useExample": "使用案例",
  "workflow.home.example.researchBuildTest.title": "研究、實作與測試",
  "workflow.home.example.researchBuildTest.description": "從研究到實作，再到驗證的順序式工程流程。",
  "workflow.home.example.contentReview.title": "內容審核",
  "workflow.home.example.contentReview.description": "先產生內容，再進行審核，最後等待人工批准。",
  "workflow.home.example.parallelFeedback.title": "平行回饋",
  "workflow.home.example.parallelFeedback.description": "將一項工作同時交給兩個獨立審核節點分析。",
  "workflow.template.eyebrow": "工作流程範本",
  "workflow.template.save": "儲存",
  "workflow.template.saving": "正在儲存...",
  "workflow.template.addNode": "新增節點",
  "workflow.template.addRoot": "新增根節點",
  "workflow.template.unavailable": "此工作流程範本無法使用。",
  "workflow.template.invalid": "無法儲存此圖。",
  "workflow.template.nodeTitle": "節點標題",
  "workflow.template.nodeObjective": "節點目標",
  "workflow.template.deleteNode": "移除節點",
  "workflow.template.deleteEdge": "移除連線",
  "workflow.template.inputPort": "輸入連接埠",
  "workflow.template.outputPort": "輸出連接埠",
  "workflow.template.queuePort": "佇列輸入",
  "workflow.template.messagePort": "訊息輸出",
  "workflow.template.basePrompt": "專案提示詞檔案",
  "workflow.template.nodePrompt": "節點提示詞檔案",
  "workflow.template.promptPlaceholder": ".opencode/workflow/prompt.md",
  "workflow.template.directory": "工作區目錄",
  "workflow.template.directoryPlaceholder": "/path/to/project",
  "workflow.template.canvasHint": "拖曳節點即可移動。Ctrl 單擊加入多選。空白處拖曳框選。中鍵拖曳畫布。右鍵開啟選單。",
  "workflow.template.alias": "別名",
  "workflow.template.notes": "備註",
  "workflow.template.showInputs": "顯示輸入連接埠",
  "workflow.template.hideInputs": "隱藏輸入連接埠",
  "workflow.template.showOutputs": "顯示輸出連接埠",
  "workflow.template.hideOutputs": "隱藏輸出連接埠",
  "workflow.template.tools": "允許使用的工具",
  "workflow.template.toolsAll": "所有工具",
  "workflow.template.toolsSelected": "已選擇 {count} 個",
  "workflow.template.inputs": "輸入",
  "workflow.template.outputs": "輸出",
  "workflow.template.showWorkspace": "顯示工作區輸入",
  "workflow.template.hideWorkspace": "隱藏工作區輸入",
  "workflow.template.showPrompt": "顯示額外提示輸入",
  "workflow.template.hidePrompt": "隱藏額外提示輸入",
  "workflow.template.extraPrompt": "額外提示文字",
  "workflow.template.noDirectory": "無目錄",
  "workflow.template.addPrompt": "新增提示連接埠",
  "workflow.template.addInput": "新增輸入連接埠",
  "workflow.template.addOutput": "新增輸出連接埠",
  "workflow.template.description.root": "啟動工作流程",
  "workflow.template.description.task": "一般工作流程任務",
  "workflow.template.description.research": "收集並分析資訊",
  "workflow.template.description.implement": "修改檔案並完成實作",
  "workflow.template.description.review": "檢查品質與正確性",
  "workflow.template.description.test": "執行測試並回報失敗",
  "workflow.template.description.approval": "等待人工決策",
  "workflow.template.port.context": "上下文",
  "workflow.template.port.inbox": "收件匣",
  "workflow.template.port.result": "結果",
  "workflow.template.port.message": "訊息",
  "workflow.template.tooltip.input": "輸入連接埠",
  "workflow.template.tooltip.output": "輸出連接埠",
  "workflow.kind.root": "根節點",
  "workflow.kind.task": "任務",
  "workflow.kind.research": "研究",
  "workflow.kind.implement": "實作",
  "workflow.kind.review": "審查",
  "workflow.kind.test": "測試",
  "workflow.kind.approval": "核准",
  "workflow.template.kind": "類型",
