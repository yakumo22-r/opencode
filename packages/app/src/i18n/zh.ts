...
export const dict = {
  ...
  "workflow.run.unavailable": "此工作流运行不可用。",
  "workflow.run.nodes": "节点",
  "workflow.run.active": "运行中",
  "workflow.run.cost": "预估成本",
  "workflow.run.graph": "工作流图",
  "workflow.run.connections": "条连接",
  "workflow.run.noDirectory": "没有工作区目录",
  "workflow.run.defaultModel": "默认模型",
  "workflow.run.defaultModelNamed": "默认模型（{{model}}）",
  "workflow.run.activity": "最近活动",
  "workflow.run.noActivity": "尚无工作流事件",
  "workflow.run.costBreakdown": "成本明细",
  "workflow.run.unpriced": "{{count}} 次未定价尝试",
  "workflow.run.admit": "接纳就绪节点",
  "workflow.run.admitting": "正在接纳...",
  "workflow.run.execute": "运行已接纳节点",
  "workflow.run.executing": "正在运行...",
  "workflow.run.advance": "运行直到空闲",
  "workflow.run.advancing": "正在运行直到空闲...",
  "workflow.run.openSession": "打开会话",
  "workflow.run.noSession": "还没有会话",
  "workflow.run.queue": "待处理交接",
  "workflow.run.noQueue": "没有待处理的队列消息",
  "workflow.run.acknowledge": "确认",
  "workflow.run.acknowledging": "正在确认...",
  "workflow.run.connectionCount": "{{count}} 条连接",
  "workflow.run.event.status": "{{node}} 现在处于{{status}}",
  "workflow.run.event.handoff": "{{source}} 向 {{target}} 发送了交接",
  "workflow.run.event.ack": "{{node}} 已确认 {{port}}",
  ...
  "workflow.home.eyebrow": "工作流",
  "workflow.home.title": "查看工作流运行",
  "workflow.home.description": "打开一个持久化工作流运行，查看节点状态、交接信息和模型成本。",
  "workflow.home.placeholder": "工作流运行 ID",
  "workflow.home.open": "打开运行",
  "workflow.home.projects": "项目",
  "workflow.home.noProject": "打开一个项目以列出模板和运行。",
  "workflow.home.templates": "模板",
  "workflow.home.noTemplates": "还没有工作流模板",
  "workflow.home.runs": "最近运行",
  "workflow.home.noRuns": "还没有工作流运行",
  "workflow.home.create": "创建模板",
  "workflow.home.creating": "正在创建...",
  "workflow.home.titlePlaceholder": "模板标题",
  "workflow.home.objectivePlaceholder": "第一个节点应该做什么？",
  "workflow.home.start": "开始运行",
  "workflow.home.requirementPlaceholder": "这次运行要做什么？",
  "workflow.home.starting": "正在开始...",
  "workflow.home.nodeCount": "{{count}} 个节点",
  "workflow.home.edit": "编辑",
  "workflow.home.examples": "案例模板",
  "workflow.home.examplesDescription": "从现成工作流开始，然后在画布中继续调整。",
  "workflow.home.useExample": "使用案例",
  "workflow.home.example.researchBuildTest.title": "研究、实现与测试",
  "workflow.home.example.researchBuildTest.description": "从调研到实现再到验证的顺序式工程流程。",
  "workflow.home.example.contentReview.title": "内容审核",
  "workflow.home.example.contentReview.description": "先生成内容，再审核，最后等待人工批准。",
  "workflow.home.example.parallelFeedback.title": "并行反馈",
  "workflow.home.example.parallelFeedback.description": "将一个任务同时交给两个独立审核节点分析。",
  "workflow.template.eyebrow": "工作流模板",
  "workflow.template.save": "保存",
  "workflow.template.saving": "正在保存...",
  "workflow.template.addNode": "添加节点",
  "workflow.template.addRoot": "添加根节点",
  "workflow.template.unavailable": "此工作流模板不可用。",
  "workflow.template.invalid": "无法保存此图。",
  "workflow.template.nodeTitle": "节点标题",
  "workflow.template.nodeObjective": "节点目标",
  "workflow.template.deleteNode": "移除节点",
  "workflow.template.deleteEdge": "移除连接",
  "workflow.template.inputPort": "输入端口",
  "workflow.template.outputPort": "输出端口",
  "workflow.template.queuePort": "队列输入",
  "workflow.template.messagePort": "消息输出",
  "workflow.template.basePrompt": "项目提示词文件",
  "workflow.template.nodePrompt": "节点提示词文件",
  "workflow.template.promptPlaceholder": ".opencode/workflow/prompt.md",
  "workflow.template.kind": "类型",
  "workflow.template.agent": "Agent",
  "workflow.template.model": "模型",
  "workflow.template.modelPlaceholder": "provider/model",
  "workflow.template.directory": "工作区目录",
  "workflow.template.directoryPlaceholder": "/path/to/project",
  "workflow.template.canvasHint": "拖动节点即可移动。Ctrl 单击加入多选。空白处拖动框选。中键拖动画布。右键打开菜单。",
  "workflow.template.alias": "别名",
  "workflow.template.notes": "备注",
  "workflow.template.showInputs": "显示输入端口",
  "workflow.template.hideInputs": "隐藏输入端口",
  "workflow.template.showOutputs": "显示输出端口",
  "workflow.template.hideOutputs": "隐藏输出端口",
  "workflow.template.tools": "允许使用的工具",
  "workflow.template.toolsAll": "全部工具",
  "workflow.template.toolsSelected": "已选择 {count} 个",
  "workflow.template.inputs": "输入",
  "workflow.template.outputs": "输出",
  "workflow.template.showWorkspace": "显示工作区输入",
  "workflow.template.hideWorkspace": "隐藏工作区输入",
  "workflow.template.showPrompt": "显示额外提示输入",
  "workflow.template.hidePrompt": "隐藏额外提示输入",
  "workflow.template.extraPrompt": "额外提示文本",
  "workflow.template.noDirectory": "无目录",
  "workflow.template.addPrompt": "添加提示端口",
  "workflow.template.addInput": "添加输入端口",
  "workflow.template.addOutput": "添加输出端口",
  "workflow.template.description.root": "启动工作流",
  "workflow.template.description.task": "通用工作流任务",
  "workflow.template.description.research": "收集并分析信息",
  "workflow.template.description.implement": "修改文件并完成实现",
  "workflow.template.description.review": "检查质量和正确性",
  "workflow.template.description.test": "运行测试并报告失败",
  "workflow.template.description.approval": "等待人工决策",
  "workflow.template.port.context": "上下文",
  "workflow.template.port.inbox": "收件箱",
  "workflow.template.port.result": "结果",
  "workflow.template.port.message": "消息",
  "workflow.template.tooltip.input": "输入端口",
  "workflow.template.tooltip.output": "输出端口",
  "workflow.kind.root": "根节点",
  "workflow.kind.task": "任务",
  "workflow.kind.research": "调研",
  "workflow.kind.implement": "实现",
